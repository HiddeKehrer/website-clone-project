      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mt-8 flex justify-center">
          <div className="inline-flex rounded-lg bg-gray-200 p-1">
            <button
              ...
              className={`px-6 py-1.5 rounded-md text-sm font-medium ${currency === 'usd' ? 'bg-white shadow-sm' : 'hover:bg-gray-100'}`}
            >
              USD
            </button>
            <button
              onClick={() => setCurrency('aud')}
              className={`px-6 py-1.5 rounded-md text-sm font-medium ${currency === 'aud' ? 'bg-white shadow-sm' : 'hover:bg-gray-100'}`}
            >
              AUD
            </button>
          </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-start lg:gap-6">
          {pricingData.map((plan, index) => (
            <div key={index} className={`bg-emphasis rounded-2xl border border-gray-200 p-8 flex flex-col h-full relative ${plan.cardStyle} ${index === 2 ? 'lg:mt-[-20px]' : ''}`}>
              ...
              <div className="mt-6 flex-grow">
                ...
                <p className="mt-4 text-center min-h-[80px]">{plan.description}</p>
              ...
              <div className="mt-8 flex flex-col gap-4">
                <a href={plan.ctaPrimary.href} className="w-full text-center bg-black text-white px-6 py-3 rounded-lg font-semibold">
                  {plan.ctaPrimary.text}
                </a>
                <a href={plan.ctaSecondary.href} className="w-full text-center bg-emphasis border border-gray-300 px-6 py-3 rounded-lg font-semibold">
        ...
        <p className="text-center mt-16">
          ...
          <a href="https://peekinsights.co/contact-us/" className="underline">
            contact us
          </a>
        </p>
      </div>
