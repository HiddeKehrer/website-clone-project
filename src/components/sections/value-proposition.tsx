...
export default function ValueProposition() {
  ...
  const tabs = [
    { id: 'connect', label: 'Seamless integration', number: '1', subtitle: 'Connect your application without engineering effort, import all flows from your existing application and start experimenting.', videoSrc: '/connect.mp4' },
    { id: 'create', label: 'Endless customization', number: '2', subtitle: 'Launch experiments at scale, create flows, A/n tests and optimize for everything.', videoSrc: '/video_create.mp4' },
    { id: 'monitor', label: 'Effortless monitoring', number: '3', subtitle: 'Track performance, monitor outcomes and reach maximum impact for every feature and every flow.', videoSrc: '/monitor.mp4' }
  ];
